...
#include "inc/hw_ints.h"		//Macros that define the interrupt assignment on Tiva C Series MCUs
...
#include "usblib/usblib.h"		//Main header file for the USB Library.
#include "usblib/usb-ids.h"		//Definitions of VIDs and PIDs used by USB library
#include "usblib/device/usbdevice.h"	//types and definitions used during USB enumeration
#include "usblib/device/usbdbulk.h"		//USBLib support for a generic bulk device
...
#include "usb_bulk_structs.h"			//Data structures defining this bulk USB device
